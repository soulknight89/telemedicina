...
class Layout
{
	...
	public $title       = 'Phuyu | Recursos para Desarrolladores';		
	public $descripcion = 'Un lugar para los que crean la web.';
	...
	public function js_end($archivos = array()){
		foreach ( $archivos as $archivo )
			$this->js .= "<script type=\"text/javascript\" src=\"{$archivo}\"></script>\n";
	}
	...
	public function css_end($archivos = array())	{
		foreach ( $archivos as $archivo )
			$this->css .= "<link type=\"text/css\" rel=\"stylesheet\" href=\"{$archivo}\" />\n";
	}
}
